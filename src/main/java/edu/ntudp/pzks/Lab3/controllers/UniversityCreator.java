...
import edu.ntudp.pzks.Lab3.models.*;
...
public class UniversityCreator {
    ...
    public static University createTypicalUniversity() {
        ...
        Student firstStudent = newStudent.createStudent("Yurova", "Anastasia", "Kyryllovna", Sex.FEMALE);
        ...
        Student ninthStudent = newStudent.createStudent("Fesenko", "Andrii", "Volodymyrovych", Sex.MALE);
        ...
        Group firstGroup = createGroup("122-21ZSK-1", firstStudent, studentsOfGroupComputerScience);
        Group secondGroup = createGroup("124-21ZSK-1", seventhStudent, studentsOfGroupSystemAnalynisis);
        Group thirdGroup = createGroup("121-21ZSK-1", ninthStudent, studentsOfGroupSoftwareEngineering);
